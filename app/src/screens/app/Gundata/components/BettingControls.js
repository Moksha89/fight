...
const coins = [
  ...
  },
  {
    id: '200',
    value: 200,
    image: require('../../../../assets/icons/200Coin.png'),
    activeImage: require('../../../../assets/icons/200CoinActive.png'),
  },
  {
    id: '300',
    value: 300,
  ...
  },
  {
    id: '2500',
    value: 2500,
    image: require('../../../../assets/icons/2500Coin.png'),
    activeImage: require('../../../../assets/icons/2500CoinActive.png'),
  },
  {
    id: '5000',
    value: 5000,
...
export default function BettingControls({
  ...
  const generateRatios = (
    ...
    if (activeChannel == 0) {
      ...
      if (!liveMatch) return ['⚔️', '⚔️', '☠️'];

      minA = parseFloat((liveMatch.minThresholdTeamA || 0.85).toFixed(2));
      maxA = parseFloat((liveMatch.maxThresholdTeamA || 1).toFixed(2));
      minB = parseFloat((liveMatch.minThresholdTeamB || 0.85).toFixed(2));
      maxB = parseFloat((liveMatch.maxThresholdTeamB || 1).toFixed(2));
      minD = parseFloat((liveMatch.minThresholdTeamDraw || 3).toFixed(2));
      maxD = parseFloat((liveMatch.maxThresholdTeamDraw || 5).toFixed(2));
    }
